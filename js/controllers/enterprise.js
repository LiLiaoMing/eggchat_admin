scpApp.controller('EnterpriseCtrl', function($scope, $location, $utils) {
	...
	$scope.gotoProfiles = function() {
		if ($scope.data.client === undefined)
			alert('Please select client first.');
		else
		{
			localStorage.setItem('client', JSON.stringify($scope.data.client));
			$utils.client = $scope.data.client;
