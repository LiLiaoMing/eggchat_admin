scpApp.controller('ComponentCtrl', function($scope, $components, $timeout, $location, $stateParams) {

	$scope.components = [];
	$scope.data = {};
	$scope.data.isAdmin = (localStorage.getItem('permission') == 'Administrator');
	$scope.data.project_id = $stateParams.projectId;
	$scope.data.project_name = $stateParams.projectName;

	$scope.init = function() {

		$components.get($scope.data.project_id, function(res) {
	...
	$scope.gotoCreate = function() {
		$location.path('app/component/' + $scope.data.project_id + '/' + $scope.data.project_name + '/');
	}

	$scope.delete = function(id) {
		$components.delete(id, function() {
			$scope.init();
		}, function() {
